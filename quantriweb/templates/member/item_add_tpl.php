...
<form name="supplier" id="validate" class="form" action="index.php?com=member&act=save" method="post" enctype="multipart/form-data">	        
    <div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
				<input readonly type="text" value="<?=tinhthanh($item['id_city'],'tinh')?>" name="id_city" title="Nhập địa chỉ của bạn" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
			...
			<div class="formRight">
				<input readonly type="text" value="<?=tinhthanh($item['id_district'],'quan')?>" name="id_district" title="Nhập địa chỉ của bạn" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
