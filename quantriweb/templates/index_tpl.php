...
<div class="widget">
   <div class="title"><h6>Chào mừng bạn đến với Administrator - HỆ THỐNG QUẢN TRỊ NỘI DUNG WEBSITE - Powered by </h6><div class="clear"></div></div>
...
<script>
    ...
    <script>
        ...
        option = {
            ...
            title: {
                text: 'Device',
                subtext: 'Devetloper Thep Bao An',
                x: 'center'
            },
            toolbox: {
                show: true,
...
<script>
        ...
        option = {
            title: {
                text: 'Nation',
                subtext: 'Devetloper Thep Bảo An',
                sublink: 'http://thepbaoan.com/'
            },
            tooltip: {
                trigger: 'axis',
                axisPointer: {
